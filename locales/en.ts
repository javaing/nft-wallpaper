export default {
  ...
  display_history_title: 'Displayed Wallpapers',
  display_history_empty: 'No display history yet',
  display_history_empty_sub: 'Auto-changed wallpapers will appear here',
