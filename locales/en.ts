export default {
  ...
  display_history_title: "Today's Display History",
  display_history_empty: 'Nothing displayed today yet',
  display_history_empty_sub: 'Clears at midnight; shows only today\'s wallpapers',
